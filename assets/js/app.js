...
var docfiltrar = document.querySelector('#docfiltrar');
filtrar.forEach(function (el) {
    el.addEventListener("click", function (e) {
        if(docfiltrar.classList.contains("search-active")){
            docfiltrar.classList.remove("search-active");
        }
        else{
            docfiltrar.classList.add("search-active");
        }
    })
});
///////////////////////////////////////////////////////////////////////////
